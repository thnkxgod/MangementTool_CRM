...
const ClientView = () => {
  ...
  const [inventory, setInventory] = useState([]); // Your inventory data
  ...
  // Example functions for handling inventory selection
  ...
  const generateDescription = () => {
    // Define how you'd like to generate a description
    console.log(
      "Description generated based on selected items:",
      selectedItems
    );
          ...
          >
            ...
            <div className="grid grid-cols-[auto_1.8fr_1.2fr] w-full h-full items-center justify-center">
              ...
              <div className="min-h-[50vh]  flex flex-col items-center justify-center mr-2 shadow-xl p-4">
                <div className="relative bg-gradient-to-t from-[#c9cdd1] to-[#f1f1f1] bg-opacity-100 p-8 text-center overflow-auto h-[550px] scrollbar-hide rounded-md w-full">
                  <div>
                    ...
                    <InventorySelectionModal
                      ...
                      handleSelectItem={handleInventoryItemSelect} // Updated function name here
                      selectedItems={selectedInventoryItems} // Updated state name here
                  ...
                  >
                    <div className="flex items-center overflow-hidden  relative">
                      {/* Left arrow */}
                      <button
                        className="absolute left-0 z-10 text-gray-600 hover:text-gray-800 p-2"
                      ...
                      >
                        <img
                          ...
                          style={{
                            ...
                            height: "30px",
                            filter:
                              "invert(100%) sepia(0%) saturate(0%) brightness(70%) contrast(100%)",
                          }}
                        />
                      </button>
                      ...
                      {/* Right arrow */}
                      <button
                        className="absolute right-0 z-10 text-gray-600 hover:text-gray-800 p-2"
                        style={{ top: "50%", transform: "translateY(-50%)" }}
                        onClick={() => {
                          document
                            .getElementById(`carousel-${item.id}`)
                      ...
                      >
                        <img
                          ...
                          style={{
                            ...
                            height: "30px",
                            filter:
                              "invert(100%) sepia(0%) saturate(0%) brightness(90%) contrast(100%)",
                          }}
                        />
                      </button>
                    </div>
