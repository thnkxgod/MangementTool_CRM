...
const ClientView = () => {
  ...
  return (
    <div className="relative h-screen w-full overflow-y-auto scrollbar-hide snap-y snap-mandatory">
      ...
      <div className="fixed right-4 bg-black w-30 p-4 bg-opacity-75 rounded-b-xl z-10">
        <img src={redlogo} alt="Company Logo" className="size-32 h-8 " />
      </div>
                ...
                <div className="relative bg-[#ececec] bg-opacity-100 p-8 text-center overflow-auto h-[550px] scrollbar-hide rounded-md w-full">
                  ...
                  >
                    <div className="flex items-center overflow-hidden relative">
                      {/* Left arrow */}
                      <button
                        className="absolute left-0 z-10 text-gray-600 hover:text-gray-800 p-3"
                      ...
                      {/* Right arrow */}
                      <button
                        className="absolute right-0 z-10 text-gray-600 hover:text-gray-800 p-3"
                        style={{ top: "50%", transform: "translateY(-50%)" }}
                        onClick={() => {
                          document
                            .getElementById(`carousel-${item.id}`)
